...
<body>
  <div id="modal_ToS" class="modal">
    <div class="modal_content">
      <span class="close">&times;</span>
        <h2>Welcome to Dices and Dragons</h2>
        <p>These terms and conditions outline the rules and regulations for the use of Dices and Dragons's Website.</p> <br /> 
        <span style="text-transform: capitalize;"> Dices and Dragons</span> is located at:<br /> 
        <address>Haagweg 1 , Breda<br />Netherlands<br />
        </address>
        <p>By accessing this website we assume you accept these terms and conditions in full. Do not continue to use Dices and Dragons's website 
        ...
        <p>We employ the use of cookies. By using Dices and Dragons's website you consent to the use of cookies 
        in accordance with Dices and Dragons’s privacy policy.</p><p>Most of the modern day interactive web sites
        use cookies to enable us to retrieve user details for each visit. Cookies are used in some areas of our site
        to enable the functionality of this area and ease of use for those people visiting. Some of our 
        affiliate / advertising partners may also use cookies.</p><h2>License</h2>
        <p>Unless otherwise stated, Dices and Dragons and/or it’s licensors own the intellectual property rights for
        all material on Dices and Dragons. All intellectual property rights are reserved. You may view and/or print
        pages from http://dicesanddragons.com for your own personal use subject to restrictions set in these terms and conditions.</p>
        <p>You must not:</p>
        <ol>
          <li>Republish material from http://dicesanddragons.com</li>
          <li>Sell, rent or sub-license material from http://dicesanddragons.com</li>
          <li>Reproduce, duplicate or copy material from http://dicesanddragons.com</li>
        </ol>
        <p>Redistribute content from Dices and Dragons (unless content is specifically made for redistribution).</p>
      <h2>User Comments</h2>
        <ol>
          <li>This Agreement shall begin on the date hereof.</li>
          <li>Certain parts of this website offer the opportunity for users to post and exchange opinions, information,
          material and data ('Comments') in areas of the website. Dices and Dragons does not screen, edit, publish
          or review Comments prior to their appearance on the website and Comments do not reflect the views or
          opinions ofDices and Dragons, its agents or affiliates. Comments reflect the view and opinion of the
          person who posts such view or opinion. To the extent permitted by applicable laws Dices and Dragonsshall
          ...
          website.</li>
          <li>Dices and Dragonsreserves the right to monitor all Comments and to remove any Comments which it considers
          ...
          <li>You hereby grant to <strong>Dices and Dragons</strong> a non-exclusive royalty-free license to use, reproduce,
      ...
      <h2>Hyperlinking to our Content</h2>
        ...
        you must notify us by sending an e-mail to <a href="mailto:mw.korsten@gmail.com" title="send an email to mw.korsten@gmail.com">mw.korsten@gmail.com</a>.
        ...
        <p>No use of Dices and Dragons’s logo or other artwork will be allowed for linking absent a trademark license
        agreement.</p>
      <h2>Iframes</h2>
